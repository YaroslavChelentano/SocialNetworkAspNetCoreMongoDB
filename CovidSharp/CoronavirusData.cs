...
namespace CovidSharp
{
    public class CoronavirusData
    {
        ...
        public string ConfirmedLast()
        {
            ...
            var ConfirmedLastData = LatestData["confirmed"].ToString();
            return ConfirmedLastData;
        }

        public string RecoveredLast()
        {
            ...
            var RecoveredLastData = LatestData["recovered"].ToString();
            return RecoveredLastData;
        }
